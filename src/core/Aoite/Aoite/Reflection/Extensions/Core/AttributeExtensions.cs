...
namespace Aoite.Reflection
{
    ...
    public static class AttributeExtensions
    {
        ...
        /// will be included in the value.</param>
        ...
        /// used to define the search behavior and value filtering.</param>
        /// <returns>A list of all matching members on the type. This value will never be null.</returns>
        ...
        /// <param name="attributeTypes">The optional list of attribute types with which members should
        /// be decorated. If this parameter is <c>null</c> or empty then all fields and properties
        /// matching the given <paramref name="bindingFlags"/> will be included in the value.</param>
        /// <returns>A list of all matching members on the type. This value will never be null.</returns>
        ...
        /// <paramref name="bindingFlags"/> will be included in the value.</param>
