...
namespace System
{
    static partial class CommandBusExtensions
    {
        ...
        /// <param name="tunnel">用于个性化表名和命令的暗道，可以为 null 值。</param>
        /// <returns>实体。</returns>
        public static Task<TView> FindOneAsync<TEntity, TView>(this ICommandBus bus, object keyValue, Func<TEntity, TView> select, ICommandTunnel tunnel = null)
            => FindOneAsync(bus, null, keyValue, select, tunnel);
