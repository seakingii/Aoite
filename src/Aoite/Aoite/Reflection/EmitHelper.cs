...
namespace Aoite.Reflection
{
    ...
    internal class EmitHelper
    {
        ...
        public EmitHelper(Type returnType, Type[] parameterTypes, Type owner, bool skipVisibility = true)
            : this(new DynamicMethod(String.Empty, returnType, parameterTypes, owner, skipVisibility))
        {
        }
        /// <summary>
        ...
        {
            if(dynamicMethod == null) throw new ArgumentNullException(nameof(dynamicMethod));
        ...
        {
            if(emitHelper == null) throw new ArgumentNullException(nameof(emitHelper));
        ...
        /// </summary>
        /// <param name="type">A Type</param>
        public EmitHelper castType_any(Type type)
        {
            if(type == null)
            {
                throw new ArgumentNullException(nameof(type));
