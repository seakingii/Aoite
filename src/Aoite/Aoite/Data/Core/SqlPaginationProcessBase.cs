...
namespace Aoite.Data
{
    ...
    /// 基于 SQL 的分页。
    /// </summary>
    public abstract class SqlPaginationProcessBase : IPaginationProcess
    {
        /// <summary>
        /// 获取默认页码字段的列名。
        /// </summary>
        ...
        public virtual void ProcessCommand(int pageNumber, int pageSize, DbCommand command)
        {
        ...
        public virtual string CreateTotalCountCommand(string commandText)
        {
