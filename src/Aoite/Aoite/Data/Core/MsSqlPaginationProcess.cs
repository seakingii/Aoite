...
namespace Aoite.Data
{
    ...
    /// 基于 MSSQL 的分页。
    /// </summary>
    public class MsSqlPaginationProcess : SqlPaginationProcessBase
    {
        /// <summary>
        /// 分页实例。
        /// </summary>
        public static readonly MsSqlPaginationProcess Instance = new MsSqlPaginationProcess();

        /// <summary>
        /// 初始化一个 <see cref="Aoite.Data.MsSqlPaginationProcess"/> 类的新实例。
        /// </summary>
        public MsSqlPaginationProcess() { }
