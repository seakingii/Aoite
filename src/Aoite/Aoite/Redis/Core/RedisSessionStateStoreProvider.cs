...
namespace Aoite.Redis
{
    ...
    public class RedisSessionStateStoreProvider : SessionStateStoreProviderBase
    {
        ...
        /// <summary>
        /// 由 <see cref="SessionStateModule"/> 对象调用，以便进行每次请求初始化。
        /// </summary>
        /// <param name="context">当前请求的 <see cref="HttpContext"/>。</param>
        public override void InitializeRequest(HttpContext context) { }

        /// <summary>
        ///在请求结束时由 <see cref="SessionStateModule"/> 对象调用。
        /// </summary>
        /// <param name="context">当前请求的 <see cref="HttpContext"/>。</param>
        public override void EndRequest(HttpContext context) { }

        /// <summary>
        /// 创建要用于当前请求的新 <see cref="SessionStateStoreData"/> 对象。
        /// </summary>
        /// <param name="context">当前请求的 <see cref="HttpContext"/>。</param>
        /// <param name="timeout">新 <see cref="SessionStateStoreData"/> 的会话状态 <see cref="HttpSessionState.Timeout"/> 值。</param>
        /// <returns>当前请求的新 <see cref="SessionStateStoreData"/>。</returns>
        ...
        /// </summary>
        /// <param name="context">当前请求的 <see cref="HttpContext"/>。</param>
        /// <param name="id">当前请求的 <see cref="HttpSessionState.SessionID"/>。</param>
        /// <param name="timeout">当前请求的会话 <see cref="HttpSessionState.Timeout"/>。</param>
        ...
        /// <param name="lockId">当此方法返回时，请包含一个设置为当前请求的锁定标识符的对象。有关锁定标识符的详细信息，请参见 <see cref="SessionStateStoreProviderBase"/> 类摘要中的“锁定会话存储区数据”。</param>
        /// <param name="actions">当此方法返回时，请包含 <see cref="SessionStateActions"/> 值之一，指示当前会话是否为未初始化的无 Cookie 会话。</param>
        /// <returns>使用会话数据存储区中的会话值和信息填充的 <see cref="SessionStateStoreData"/>。</returns>
        ...
        /// <param name="id">当前请求的会话标识符。</param>
        /// <param name="lockId">当前请求的锁定标识符。</param>
        /// <param name="item">表示将从数据存储区中删除的项的 <see cref="SessionStateStoreData"/>。</param>
        ...
        /// <summary>
        /// 设置对 Global.asax 文件中定义的 Session_OnEnd 事件的 <see cref="SessionStateItemExpireCallback"/> 委托的引用。
        /// </summary>
        /// <param name="expireCallback">对 Global.asax 文件中定义的 Session_OnEnd 事件的 <see cref="SessionStateItemExpireCallback"/> 委托。</param>
